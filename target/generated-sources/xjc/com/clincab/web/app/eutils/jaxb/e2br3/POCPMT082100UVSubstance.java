...
/**
 * <p>Java class for POCP_MT082100UV.Substance complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_MT082100UV.Substance"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asNamedEntity" type="{urn:hl7-org:v3}POCP_MT082100UV.NamedEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asEquivalentSubstance" type="{urn:hl7-org:v3}POCP_MT082100UV.EquivalentSubstance" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asSpecializedKind" type="{urn:hl7-org:v3}POCP_MT010300UV.SpecializedKind" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="moiety" type="{urn:hl7-org:v3}POCP_MT082100UV.Moiety" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ingredient" type="{urn:hl7-org:v3}POCP_MT082100UV.Ingredient" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_MT082100UV.Substance", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCPMT082100UVSubstance {
    ...
    protected List<POCPMT082100UVNamedEntity> asNamedEntity;
    @XmlElement(nillable = true)
    protected List<POCPMT082100UVEquivalentSubstance> asEquivalentSubstance;
    @XmlElement(nillable = true)
    protected List<POCPMT010300UVSpecializedKind> asSpecializedKind;
    @XmlElement(nillable = true)
    protected List<POCPMT082100UVMoiety> moiety;
    @XmlElement(nillable = true)
    protected List<POCPMT082100UVIngredient> ingredient;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT082100UVNamedEntity }
     * 
     * 
     */
    public List<POCPMT082100UVNamedEntity> getAsNamedEntity() {
        if (asNamedEntity == null) {
            asNamedEntity = new ArrayList<POCPMT082100UVNamedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT082100UVEquivalentSubstance }
     * 
     * 
     */
    public List<POCPMT082100UVEquivalentSubstance> getAsEquivalentSubstance() {
        if (asEquivalentSubstance == null) {
            asEquivalentSubstance = new ArrayList<POCPMT082100UVEquivalentSubstance>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT082100UVMoiety }
     * 
     * 
     */
    public List<POCPMT082100UVMoiety> getMoiety() {
        if (moiety == null) {
            moiety = new ArrayList<POCPMT082100UVMoiety>();
        }
        return this.moiety;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT082100UVIngredient }
     * 
     * 
     */
    public List<POCPMT082100UVIngredient> getIngredient() {
        if (ingredient == null) {
            ingredient = new ArrayList<POCPMT082100UVIngredient>();
        }
