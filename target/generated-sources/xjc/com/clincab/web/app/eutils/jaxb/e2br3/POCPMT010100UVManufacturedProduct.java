...
/**
 * <p>Java class for POCP_MT010100UV.ManufacturedProduct complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_MT010100UV.ManufacturedProduct"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;group ref="{urn:hl7-org:v3}InfrastructureRootElements"/&gt;
 *         &lt;element name="id" type="{urn:hl7-org:v3}II" minOccurs="0"/&gt;
 *         &lt;element name="manufacturedProduct" type="{urn:hl7-org:v3}POCP_MT010100UV.Product"/&gt;
 ...
 *         &lt;element name="deviceOf" type="{urn:hl7-org:v3}POCP_MT010100UV.Device" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="consumedIn" type="{urn:hl7-org:v3}POCP_MT010100UV.Consumable1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="productOf" type="{urn:hl7-org:v3}POCP_MT010100UV.Product3" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="indirectTargetOf" type="{urn:hl7-org:v3}POCP_MT010100UV.IndirectTarget" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_MT010100UV.ManufacturedProduct", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCPMT010100UVManufacturedProduct {
    ...
    protected POCPMT010100UVProduct manufacturedProduct;
    ...
    @XmlElement(nillable = true)
    protected List<POCPMT010100UVDevice> deviceOf;
    @XmlElement(nillable = true)
    protected List<POCPMT010100UVConsumable1> consumedIn;
    @XmlElement(nillable = true)
    protected List<POCPMT010100UVProduct3> productOf;
    @XmlElement(nillable = true)
    protected List<POCPMT010100UVIndirectTarget> indirectTargetOf;
     ...
     * @return
     *     possible object is
     *     {@link POCPMT010100UVProduct }
     *     
     */
    public POCPMT010100UVProduct getManufacturedProduct() {
     ...
     *     
     */
    public void setManufacturedProduct(POCPMT010100UVProduct value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010100UVDevice }
     * 
     * 
     */
    public List<POCPMT010100UVDevice> getDeviceOf() {
        if (deviceOf == null) {
            deviceOf = new ArrayList<POCPMT010100UVDevice>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010100UVConsumable1 }
     * 
     * 
     */
    public List<POCPMT010100UVConsumable1> getConsumedIn() {
        if (consumedIn == null) {
            consumedIn = new ArrayList<POCPMT010100UVConsumable1>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010100UVProduct3 }
     * 
     * 
     */
    public List<POCPMT010100UVProduct3> getProductOf() {
        if (productOf == null) {
            productOf = new ArrayList<POCPMT010100UVProduct3>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010100UVIndirectTarget }
     * 
     * 
     */
    public List<POCPMT010100UVIndirectTarget> getIndirectTargetOf() {
        if (indirectTargetOf == null) {
            indirectTargetOf = new ArrayList<POCPMT010100UVIndirectTarget>();
        }
