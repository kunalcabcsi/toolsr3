...
/**
 * <p>Java class for COCT_MT050000UV10.Patient complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT050000UV10.Patient"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;choice&gt;
 *           &lt;element name="patientPerson" type="{urn:hl7-org:v3}COCT_MT050000UV10.Person" minOccurs="0"/&gt;
 *           &lt;element name="patientNonPersonLivingSubject" type="{urn:hl7-org:v3}COCT_MT050000UV10.NonPersonLivingSubject" minOccurs="0"/&gt;
 *         &lt;/choice&gt;
 *         &lt;element name="providerOrganization" type="{urn:hl7-org:v3}COCT_MT150000UV02.Organization" minOccurs="0"/&gt;
 *         &lt;element name="subjectOf" type="{urn:hl7-org:v3}COCT_MT050000UV10.Subject4" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="coveredPartyOf" type="{urn:hl7-org:v3}COCT_MT050000UV10.CoveredParty" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "COCT_MT050000UV10.Patient", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class COCTMT050000UV10Patient {
    ...
    protected JAXBElement<COCTMT050000UV10Person> patientPerson;
    @XmlElementRef(name = "patientNonPersonLivingSubject", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTMT050000UV10NonPersonLivingSubject> patientNonPersonLivingSubject;
    ...
    protected List<COCTMT050000UV10Subject4> subjectOf;
    @XmlElement(nillable = true)
    protected List<COCTMT050000UV10CoveredParty> coveredPartyOf;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT050000UV10Person }{@code >}
     *     
     */
    public JAXBElement<COCTMT050000UV10Person> getPatientPerson() {
     ...
     *     
     */
    public void setPatientPerson(JAXBElement<COCTMT050000UV10Person> value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT050000UV10NonPersonLivingSubject }{@code >}
     *     
     */
    public JAXBElement<COCTMT050000UV10NonPersonLivingSubject> getPatientNonPersonLivingSubject() {
     ...
     *     
     */
    public void setPatientNonPersonLivingSubject(JAXBElement<COCTMT050000UV10NonPersonLivingSubject> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UV10Subject4 }
     * 
     * 
     */
    public List<COCTMT050000UV10Subject4> getSubjectOf() {
        if (subjectOf == null) {
            subjectOf = new ArrayList<COCTMT050000UV10Subject4>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT050000UV10CoveredParty }
     * 
     * 
     */
    public List<COCTMT050000UV10CoveredParty> getCoveredPartyOf() {
        if (coveredPartyOf == null) {
            coveredPartyOf = new ArrayList<COCTMT050000UV10CoveredParty>();
        }
