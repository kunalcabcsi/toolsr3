...
/**
 * <p>Java class for PORR_MT049013UV.Procedure complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PORR_MT049013UV.Procedure"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="device" type="{urn:hl7-org:v3}PORR_MT049013UV.Device" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="product" type="{urn:hl7-org:v3}PORR_MT049013UV.Product3" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "PORR_MT049013UV.Procedure", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PORRMT049013UVProcedure {
    ...
    protected List<PORRMT049013UVDevice> device;
    @XmlElement(nillable = true)
    protected List<PORRMT049013UVProduct3> product;
    @XmlElement(nillable = true)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PORRMT049013UVDevice }
     * 
     * 
     */
    public List<PORRMT049013UVDevice> getDevice() {
        if (device == null) {
            device = new ArrayList<PORRMT049013UVDevice>();
        }
        return this.device;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PORRMT049013UVProduct3 }
     * 
     * 
     */
    public List<PORRMT049013UVProduct3> getProduct() {
        if (product == null) {
            product = new ArrayList<PORRMT049013UVProduct3>();
        }
        return this.product;
    }
