...
/**
 * <p>Java class for POCP_HD010500UV.ManufacturedProduct complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_HD010500UV.ManufacturedProduct"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;group ref="{urn:hl7-org:v3}InfrastructureRootElements"/&gt;
 *         &lt;element name="id" type="{urn:hl7-org:v3}II" minOccurs="0"/&gt;
 *         &lt;element name="manufacturedProduct" type="{urn:hl7-org:v3}POCP_HD010500UV.Product"/&gt;
 ...
 *         &lt;element name="deviceOf" type="{urn:hl7-org:v3}POCP_HD010500UV.Device" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="consumedIn" type="{urn:hl7-org:v3}POCP_HD010500UV.Consumable1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="productOf" type="{urn:hl7-org:v3}POCP_HD010500UV.Product3" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "POCP_HD010500UV.ManufacturedProduct", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCPHD010500UVManufacturedProduct {
    ...
    protected POCPHD010500UVProduct manufacturedProduct;
    ...
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVDevice> deviceOf;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVConsumable1> consumedIn;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVProduct3> productOf;
    @XmlElement(nillable = true)
     ...
     * @return
     *     possible object is
     *     {@link POCPHD010500UVProduct }
     *     
     */
    public POCPHD010500UVProduct getManufacturedProduct() {
     ...
     *     
     */
    public void setManufacturedProduct(POCPHD010500UVProduct value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVDevice }
     * 
     * 
     */
    public List<POCPHD010500UVDevice> getDeviceOf() {
        if (deviceOf == null) {
            deviceOf = new ArrayList<POCPHD010500UVDevice>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVConsumable1 }
     * 
     * 
     */
    public List<POCPHD010500UVConsumable1> getConsumedIn() {
        if (consumedIn == null) {
            consumedIn = new ArrayList<POCPHD010500UVConsumable1>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVProduct3 }
     * 
     * 
     */
    public List<POCPHD010500UVProduct3> getProductOf() {
        if (productOf == null) {
            productOf = new ArrayList<POCPHD010500UVProduct3>();
        }
