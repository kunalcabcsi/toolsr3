...
/**
 * <p>Java class for POCP_HD020100UV.ProductInstance complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_HD020100UV.ProductInstance"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asIdentifiedItem" type="{urn:hl7-org:v3}POCP_HD020100UV.IdentifiedItem" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asContent" type="{urn:hl7-org:v3}POCP_HD020100UV.Content2" minOccurs="0"/&gt;
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}POCP_HD020100UV.Member" minOccurs="0"/&gt;
 *         &lt;element name="asInstanceOfKind" type="{urn:hl7-org:v3}POCP_HD020100UV.InstanceOfKind2" minOccurs="0"/&gt;
 *         &lt;element name="part" type="{urn:hl7-org:v3}POCP_HD020100UV.Part" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ingredient" type="{urn:hl7-org:v3}POCP_HD020100UV.Ingredient1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="member" type="{urn:hl7-org:v3}POCP_HD020100UV.Member1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_HD020100UV.ProductInstance", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCPHD020100UVProductInstance {
    ...
    protected List<POCPHD020100UVIdentifiedItem> asIdentifiedItem;
    @XmlElementRef(name = "asContent", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<POCPHD020100UVContent2> asContent;
    @XmlElementRef(name = "asMember", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<POCPHD020100UVMember> asMember;
    @XmlElementRef(name = "asInstanceOfKind", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<POCPHD020100UVInstanceOfKind2> asInstanceOfKind;
    @XmlElement(nillable = true)
    protected List<POCPHD020100UVPart> part;
    @XmlElement(nillable = true)
    protected List<POCPHD020100UVIngredient1> ingredient;
    @XmlElement(nillable = true)
    protected List<POCPHD020100UVMember1> member;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD020100UVIdentifiedItem }
     * 
     * 
     */
    public List<POCPHD020100UVIdentifiedItem> getAsIdentifiedItem() {
        if (asIdentifiedItem == null) {
            asIdentifiedItem = new ArrayList<POCPHD020100UVIdentifiedItem>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link POCPHD020100UVContent2 }{@code >}
     *     
     */
    public JAXBElement<POCPHD020100UVContent2> getAsContent() {
        return asContent;
    }
     ...
     *     
     */
    public void setAsContent(JAXBElement<POCPHD020100UVContent2> value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link POCPHD020100UVMember }{@code >}
     *     
     */
    public JAXBElement<POCPHD020100UVMember> getAsMember() {
        return asMember;
    }
     ...
     *     
     */
    public void setAsMember(JAXBElement<POCPHD020100UVMember> value) {
        this.asMember = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link POCPHD020100UVInstanceOfKind2 }{@code >}
     *     
     */
    public JAXBElement<POCPHD020100UVInstanceOfKind2> getAsInstanceOfKind() {
     ...
     *     
     */
    public void setAsInstanceOfKind(JAXBElement<POCPHD020100UVInstanceOfKind2> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD020100UVPart }
     * 
     * 
     */
    public List<POCPHD020100UVPart> getPart() {
        if (part == null) {
            part = new ArrayList<POCPHD020100UVPart>();
        }
        return this.part;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD020100UVIngredient1 }
     * 
     * 
     */
    public List<POCPHD020100UVIngredient1> getIngredient() {
        if (ingredient == null) {
            ingredient = new ArrayList<POCPHD020100UVIngredient1>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD020100UVMember1 }
     * 
     * 
     */
    public List<POCPHD020100UVMember1> getMember() {
        if (member == null) {
            member = new ArrayList<POCPHD020100UVMember1>();
        }
        return this.member;
    }
