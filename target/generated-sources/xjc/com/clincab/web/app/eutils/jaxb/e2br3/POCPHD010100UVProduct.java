...
/**
 * <p>Java class for POCP_HD010100UV.Product complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_HD010100UV.Product"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asIdentifiedEntity" type="{urn:hl7-org:v3}POCP_HD010100UV.IdentifiedEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asManufacturedProduct" type="{urn:hl7-org:v3}POCP_HD010100UV.ManufacturedProduct3" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asNamedEntity" type="{urn:hl7-org:v3}POCP_HD010100UV.NamedEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="instanceOfKind" type="{urn:hl7-org:v3}POCP_MT020100UV.InstanceOfKind1" minOccurs="0"/&gt;
 *         &lt;element name="asSpecializedKind" type="{urn:hl7-org:v3}POCP_HD010100UV.SpecializedKind" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asEntityWithGeneric" type="{urn:hl7-org:v3}POCP_HD010100UV.EntityWithGeneric" minOccurs="0"/&gt;
 *         &lt;element name="asEquivalentEntity" type="{urn:hl7-org:v3}POCP_HD010100UV.EquivalentEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ingredient" type="{urn:hl7-org:v3}POCP_HD010100UV.Ingredient" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asContent" type="{urn:hl7-org:v3}POCP_HD010100UV.Content" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asPartOfAssembly" type="{urn:hl7-org:v3}POCP_HD010100UV.PartOfAssembly" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="part" type="{urn:hl7-org:v3}POCP_HD010100UV.Part" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_HD010100UV.Product", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCPHD010100UVProduct {
    ...
    protected List<POCPHD010100UVIdentifiedEntity> asIdentifiedEntity;
    @XmlElement(nillable = true)
    protected List<POCPHD010100UVManufacturedProduct3> asManufacturedProduct;
    @XmlElement(nillable = true)
    protected List<POCPHD010100UVNamedEntity> asNamedEntity;
    ...
    @XmlElement(nillable = true)
    protected List<POCPHD010100UVSpecializedKind> asSpecializedKind;
    @XmlElementRef(name = "asEntityWithGeneric", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<POCPHD010100UVEntityWithGeneric> asEntityWithGeneric;
    @XmlElement(nillable = true)
    protected List<POCPHD010100UVEquivalentEntity> asEquivalentEntity;
    @XmlElement(nillable = true)
    protected List<POCPHD010100UVIngredient> ingredient;
    @XmlElement(nillable = true)
    protected List<POCPHD010100UVContent> asContent;
    @XmlElement(nillable = true)
    protected List<POCPHD010100UVPartOfAssembly> asPartOfAssembly;
    @XmlElement(nillable = true)
    protected List<POCPHD010100UVPart> part;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010100UVIdentifiedEntity }
     * 
     * 
     */
    public List<POCPHD010100UVIdentifiedEntity> getAsIdentifiedEntity() {
        if (asIdentifiedEntity == null) {
            asIdentifiedEntity = new ArrayList<POCPHD010100UVIdentifiedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010100UVManufacturedProduct3 }
     * 
     * 
     */
    public List<POCPHD010100UVManufacturedProduct3> getAsManufacturedProduct() {
        if (asManufacturedProduct == null) {
            asManufacturedProduct = new ArrayList<POCPHD010100UVManufacturedProduct3>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010100UVNamedEntity }
     * 
     * 
     */
    public List<POCPHD010100UVNamedEntity> getAsNamedEntity() {
        if (asNamedEntity == null) {
            asNamedEntity = new ArrayList<POCPHD010100UVNamedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010100UVSpecializedKind }
     * 
     * 
     */
    public List<POCPHD010100UVSpecializedKind> getAsSpecializedKind() {
        if (asSpecializedKind == null) {
            asSpecializedKind = new ArrayList<POCPHD010100UVSpecializedKind>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link POCPHD010100UVEntityWithGeneric }{@code >}
     *     
     */
    public JAXBElement<POCPHD010100UVEntityWithGeneric> getAsEntityWithGeneric() {
     ...
     *     
     */
    public void setAsEntityWithGeneric(JAXBElement<POCPHD010100UVEntityWithGeneric> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010100UVEquivalentEntity }
     * 
     * 
     */
    public List<POCPHD010100UVEquivalentEntity> getAsEquivalentEntity() {
        if (asEquivalentEntity == null) {
            asEquivalentEntity = new ArrayList<POCPHD010100UVEquivalentEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010100UVIngredient }
     * 
     * 
     */
    public List<POCPHD010100UVIngredient> getIngredient() {
        if (ingredient == null) {
            ingredient = new ArrayList<POCPHD010100UVIngredient>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010100UVContent }
     * 
     * 
     */
    public List<POCPHD010100UVContent> getAsContent() {
        if (asContent == null) {
            asContent = new ArrayList<POCPHD010100UVContent>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010100UVPartOfAssembly }
     * 
     * 
     */
    public List<POCPHD010100UVPartOfAssembly> getAsPartOfAssembly() {
        if (asPartOfAssembly == null) {
            asPartOfAssembly = new ArrayList<POCPHD010100UVPartOfAssembly>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010100UVPart }
     * 
     * 
     */
    public List<POCPHD010100UVPart> getPart() {
        if (part == null) {
            part = new ArrayList<POCPHD010100UVPart>();
        }
        return this.part;
    }
