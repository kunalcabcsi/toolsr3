...
/**
 * <p>Java class for POCP_MT010200UV.Product complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_MT010200UV.Product"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asManufacturedProduct" type="{urn:hl7-org:v3}POCP_MT010200UV.ManufacturedProduct3" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asNamedEntity" type="{urn:hl7-org:v3}POCP_MT010200UV.NamedEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="instanceOfKind" type="{urn:hl7-org:v3}POCP_MT020100UV.InstanceOfKind1" minOccurs="0"/&gt;
 *         &lt;element name="asSpecializedKind" type="{urn:hl7-org:v3}POCP_MT010200UV.SpecializedKind" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asEntityWithGeneric" type="{urn:hl7-org:v3}POCP_MT010200UV.EntityWithGeneric" minOccurs="0"/&gt;
 *         &lt;element name="asEquivalentEntity" type="{urn:hl7-org:v3}POCP_MT010200UV.EquivalentEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ingredient" type="{urn:hl7-org:v3}POCP_MT010200UV.Ingredient" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asContent" type="{urn:hl7-org:v3}POCP_MT010200UV.Content" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asPartOfAssembly" type="{urn:hl7-org:v3}POCP_MT010200UV.PartOfAssembly" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="part" type="{urn:hl7-org:v3}POCP_MT010200UV.Part" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_MT010200UV.Product", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCPMT010200UVProduct {
    ...
    @XmlElement(nillable = true)
    protected List<POCPMT010200UVManufacturedProduct3> asManufacturedProduct;
    @XmlElement(nillable = true)
    protected List<POCPMT010200UVNamedEntity> asNamedEntity;
    ...
    @XmlElement(nillable = true)
    protected List<POCPMT010200UVSpecializedKind> asSpecializedKind;
    @XmlElementRef(name = "asEntityWithGeneric", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<POCPMT010200UVEntityWithGeneric> asEntityWithGeneric;
    @XmlElement(nillable = true)
    protected List<POCPMT010200UVEquivalentEntity> asEquivalentEntity;
    @XmlElement(nillable = true)
    protected List<POCPMT010200UVIngredient> ingredient;
    @XmlElement(nillable = true)
    protected List<POCPMT010200UVContent> asContent;
    @XmlElement(nillable = true)
    protected List<POCPMT010200UVPartOfAssembly> asPartOfAssembly;
    @XmlElement(nillable = true)
    protected List<POCPMT010200UVPart> part;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010200UVManufacturedProduct3 }
     * 
     * 
     */
    public List<POCPMT010200UVManufacturedProduct3> getAsManufacturedProduct() {
        if (asManufacturedProduct == null) {
            asManufacturedProduct = new ArrayList<POCPMT010200UVManufacturedProduct3>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010200UVNamedEntity }
     * 
     * 
     */
    public List<POCPMT010200UVNamedEntity> getAsNamedEntity() {
        if (asNamedEntity == null) {
            asNamedEntity = new ArrayList<POCPMT010200UVNamedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010200UVSpecializedKind }
     * 
     * 
     */
    public List<POCPMT010200UVSpecializedKind> getAsSpecializedKind() {
        if (asSpecializedKind == null) {
            asSpecializedKind = new ArrayList<POCPMT010200UVSpecializedKind>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link POCPMT010200UVEntityWithGeneric }{@code >}
     *     
     */
    public JAXBElement<POCPMT010200UVEntityWithGeneric> getAsEntityWithGeneric() {
     ...
     *     
     */
    public void setAsEntityWithGeneric(JAXBElement<POCPMT010200UVEntityWithGeneric> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010200UVEquivalentEntity }
     * 
     * 
     */
    public List<POCPMT010200UVEquivalentEntity> getAsEquivalentEntity() {
        if (asEquivalentEntity == null) {
            asEquivalentEntity = new ArrayList<POCPMT010200UVEquivalentEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010200UVIngredient }
     * 
     * 
     */
    public List<POCPMT010200UVIngredient> getIngredient() {
        if (ingredient == null) {
            ingredient = new ArrayList<POCPMT010200UVIngredient>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010200UVContent }
     * 
     * 
     */
    public List<POCPMT010200UVContent> getAsContent() {
        if (asContent == null) {
            asContent = new ArrayList<POCPMT010200UVContent>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010200UVPartOfAssembly }
     * 
     * 
     */
    public List<POCPMT010200UVPartOfAssembly> getAsPartOfAssembly() {
        if (asPartOfAssembly == null) {
            asPartOfAssembly = new ArrayList<POCPMT010200UVPartOfAssembly>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010200UVPart }
     * 
     * 
     */
    public List<POCPMT010200UVPart> getPart() {
        if (part == null) {
            part = new ArrayList<POCPMT010200UVPart>();
        }
        return this.part;
    }
