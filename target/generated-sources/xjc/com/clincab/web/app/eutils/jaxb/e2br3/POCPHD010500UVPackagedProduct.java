...
/**
 * <p>Java class for POCP_HD010500UV.PackagedProduct complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_HD010500UV.PackagedProduct"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asDistributedProduct" type="{urn:hl7-org:v3}POCP_HD010500UV.DistributedProduct" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asManufacturedProduct" type="{urn:hl7-org:v3}POCP_HD010500UV.ManufacturedProduct2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asContent" type="{urn:hl7-org:v3}POCP_HD010500UV.Content1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_HD010500UV.PackagedProduct", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCPHD010500UVPackagedProduct {
    ...
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVDistributedProduct> asDistributedProduct;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVManufacturedProduct2> asManufacturedProduct;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVContent1> asContent;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVDistributedProduct }
     * 
     * 
     */
    public List<POCPHD010500UVDistributedProduct> getAsDistributedProduct() {
        if (asDistributedProduct == null) {
            asDistributedProduct = new ArrayList<POCPHD010500UVDistributedProduct>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVManufacturedProduct2 }
     * 
     * 
     */
    public List<POCPHD010500UVManufacturedProduct2> getAsManufacturedProduct() {
        if (asManufacturedProduct == null) {
            asManufacturedProduct = new ArrayList<POCPHD010500UVManufacturedProduct2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVContent1 }
     * 
     * 
     */
    public List<POCPHD010500UVContent1> getAsContent() {
        if (asContent == null) {
            asContent = new ArrayList<POCPHD010500UVContent1>();
        }
