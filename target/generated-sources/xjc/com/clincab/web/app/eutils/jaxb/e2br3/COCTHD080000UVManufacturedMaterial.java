...
/**
 * <p>Java class for COCT_HD080000UV.ManufacturedMaterial complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_HD080000UV.ManufacturedMaterial"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asManufacturedProduct" type="{urn:hl7-org:v3}COCT_HD080000UV.ManufacturedProduct"/&gt;
 *         &lt;element name="asSpecimenStub" type="{urn:hl7-org:v3}COCT_HD080000UV.SpecimenStub" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asSpecimenInContainer" type="{urn:hl7-org:v3}COCT_HD080000UV.SpecimenInContainer" minOccurs="0"/&gt;
 *         &lt;element name="asOtherIDs" type="{urn:hl7-org:v3}COCT_HD080000UV.OtherIDs" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="derivedSpecimen" type="{urn:hl7-org:v3}COCT_HD080000UV.DerivedSpecimen" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="additive" type="{urn:hl7-org:v3}COCT_HD080000UV.Additive" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "COCT_HD080000UV.ManufacturedMaterial", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class COCTHD080000UVManufacturedMaterial {
    ...
    protected COCTHD080000UVManufacturedProduct asManufacturedProduct;
    @XmlElement(nillable = true)
    protected List<COCTHD080000UVSpecimenStub> asSpecimenStub;
    @XmlElementRef(name = "asSpecimenInContainer", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTHD080000UVSpecimenInContainer> asSpecimenInContainer;
    @XmlElement(nillable = true)
    protected List<COCTHD080000UVOtherIDs> asOtherIDs;
    @XmlElement(nillable = true)
    protected List<COCTHD080000UVDerivedSpecimen> derivedSpecimen;
    @XmlElement(nillable = true)
    protected List<COCTHD080000UVAdditive> additive;
     ...
     * @return
     *     possible object is
     *     {@link COCTHD080000UVManufacturedProduct }
     *     
     */
    public COCTHD080000UVManufacturedProduct getAsManufacturedProduct() {
     ...
     *     
     */
    public void setAsManufacturedProduct(COCTHD080000UVManufacturedProduct value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD080000UVSpecimenStub }
     * 
     * 
     */
    public List<COCTHD080000UVSpecimenStub> getAsSpecimenStub() {
        if (asSpecimenStub == null) {
            asSpecimenStub = new ArrayList<COCTHD080000UVSpecimenStub>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTHD080000UVSpecimenInContainer }{@code >}
     *     
     */
    public JAXBElement<COCTHD080000UVSpecimenInContainer> getAsSpecimenInContainer() {
     ...
     *     
     */
    public void setAsSpecimenInContainer(JAXBElement<COCTHD080000UVSpecimenInContainer> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD080000UVOtherIDs }
     * 
     * 
     */
    public List<COCTHD080000UVOtherIDs> getAsOtherIDs() {
        if (asOtherIDs == null) {
            asOtherIDs = new ArrayList<COCTHD080000UVOtherIDs>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD080000UVDerivedSpecimen }
     * 
     * 
     */
    public List<COCTHD080000UVDerivedSpecimen> getDerivedSpecimen() {
        if (derivedSpecimen == null) {
            derivedSpecimen = new ArrayList<COCTHD080000UVDerivedSpecimen>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD080000UVAdditive }
     * 
     * 
     */
    public List<COCTHD080000UVAdditive> getAdditive() {
        if (additive == null) {
            additive = new ArrayList<COCTHD080000UVAdditive>();
        }
