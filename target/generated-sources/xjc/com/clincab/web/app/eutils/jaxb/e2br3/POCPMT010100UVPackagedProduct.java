...
/**
 * <p>Java class for POCP_MT010100UV.PackagedProduct complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_MT010100UV.PackagedProduct"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asDistributedProduct" type="{urn:hl7-org:v3}POCP_MT010100UV.DistributedProduct" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asManufacturedProduct" type="{urn:hl7-org:v3}POCP_MT010100UV.ManufacturedProduct2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asContent" type="{urn:hl7-org:v3}POCP_MT010100UV.Content1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_MT010100UV.PackagedProduct", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCPMT010100UVPackagedProduct {
    ...
    @XmlElement(nillable = true)
    protected List<POCPMT010100UVDistributedProduct> asDistributedProduct;
    @XmlElement(nillable = true)
    protected List<POCPMT010100UVManufacturedProduct2> asManufacturedProduct;
    @XmlElement(nillable = true)
    protected List<POCPMT010100UVContent1> asContent;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010100UVDistributedProduct }
     * 
     * 
     */
    public List<POCPMT010100UVDistributedProduct> getAsDistributedProduct() {
        if (asDistributedProduct == null) {
            asDistributedProduct = new ArrayList<POCPMT010100UVDistributedProduct>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010100UVManufacturedProduct2 }
     * 
     * 
     */
    public List<POCPMT010100UVManufacturedProduct2> getAsManufacturedProduct() {
        if (asManufacturedProduct == null) {
            asManufacturedProduct = new ArrayList<POCPMT010100UVManufacturedProduct2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010100UVContent1 }
     * 
     * 
     */
    public List<POCPMT010100UVContent1> getAsContent() {
        if (asContent == null) {
            asContent = new ArrayList<POCPMT010100UVContent1>();
        }
