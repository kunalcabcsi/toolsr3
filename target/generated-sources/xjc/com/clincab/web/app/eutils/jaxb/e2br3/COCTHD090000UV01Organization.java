...
/**
 * <p>Java class for COCT_HD090000UV01.Organization complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_HD090000UV01.Organization"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;group ref="{urn:hl7-org:v3}InfrastructureRootElements"/&gt;
 *         &lt;element name="name" type="{urn:hl7-org:v3}EN" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asLicensedEntity" type="{urn:hl7-org:v3}COCT_HD090000UV01.LicensedEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}COCT_HD090000UV01.Member" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asRoleOther" type="{urn:hl7-org:v3}COCT_HD090000UV01.RoleOther" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asLocatedEntity" type="{urn:hl7-org:v3}COCT_MT070000UV01.LocatedEntity" minOccurs="0"/&gt;
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}COCT_HD090000UV01.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "COCT_HD090000UV01.Organization", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "name",
...
public class COCTHD090000UV01Organization {
    ...
    protected List<COCTHD090000UV01LicensedEntity> asLicensedEntity;
    @XmlElement(nillable = true)
    protected List<COCTHD090000UV01Member> asMember;
    @XmlElement(nillable = true)
    protected List<COCTHD090000UV01RoleOther> asRoleOther;
    ...
    @XmlElement(nillable = true)
    protected List<COCTHD090000UV01LanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD090000UV01LicensedEntity }
     * 
     * 
     */
    public List<COCTHD090000UV01LicensedEntity> getAsLicensedEntity() {
        if (asLicensedEntity == null) {
            asLicensedEntity = new ArrayList<COCTHD090000UV01LicensedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD090000UV01Member }
     * 
     * 
     */
    public List<COCTHD090000UV01Member> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<COCTHD090000UV01Member>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD090000UV01RoleOther }
     * 
     * 
     */
    public List<COCTHD090000UV01RoleOther> getAsRoleOther() {
        if (asRoleOther == null) {
            asRoleOther = new ArrayList<COCTHD090000UV01RoleOther>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD090000UV01LanguageCommunication }
     * 
     * 
     */
    public List<COCTHD090000UV01LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<COCTHD090000UV01LanguageCommunication>();
        }
