...
/**
 * <p>Java class for POCP_HD010500UV.Product complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_HD010500UV.Product"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asIdentifiedEntity" type="{urn:hl7-org:v3}POCP_HD010500UV.IdentifiedEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asManufacturedProduct" type="{urn:hl7-org:v3}POCP_HD010500UV.ManufacturedProduct3" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asNamedEntity" type="{urn:hl7-org:v3}POCP_HD010500UV.NamedEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="instanceOfKind" type="{urn:hl7-org:v3}POCP_MT020100UV.InstanceOfKind1" minOccurs="0"/&gt;
 *         &lt;element name="asSpecializedKind" type="{urn:hl7-org:v3}POCP_HD010500UV.SpecializedKind" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asEntityWithGeneric" type="{urn:hl7-org:v3}POCP_HD010500UV.EntityWithGeneric" minOccurs="0"/&gt;
 *         &lt;element name="asEquivalentEntity" type="{urn:hl7-org:v3}POCP_HD010500UV.EquivalentEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ingredient" type="{urn:hl7-org:v3}POCP_HD010500UV.Ingredient" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asContent" type="{urn:hl7-org:v3}POCP_HD010500UV.Content" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asPartOfAssembly" type="{urn:hl7-org:v3}POCP_HD010500UV.PartOfAssembly" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="part" type="{urn:hl7-org:v3}POCP_HD010500UV.Part" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_HD010500UV.Product", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCPHD010500UVProduct {
    ...
    protected List<POCPHD010500UVIdentifiedEntity> asIdentifiedEntity;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVManufacturedProduct3> asManufacturedProduct;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVNamedEntity> asNamedEntity;
    ...
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVSpecializedKind> asSpecializedKind;
    @XmlElementRef(name = "asEntityWithGeneric", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<POCPHD010500UVEntityWithGeneric> asEntityWithGeneric;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVEquivalentEntity> asEquivalentEntity;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVIngredient> ingredient;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVContent> asContent;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVPartOfAssembly> asPartOfAssembly;
    @XmlElement(nillable = true)
    protected List<POCPHD010500UVPart> part;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVIdentifiedEntity }
     * 
     * 
     */
    public List<POCPHD010500UVIdentifiedEntity> getAsIdentifiedEntity() {
        if (asIdentifiedEntity == null) {
            asIdentifiedEntity = new ArrayList<POCPHD010500UVIdentifiedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVManufacturedProduct3 }
     * 
     * 
     */
    public List<POCPHD010500UVManufacturedProduct3> getAsManufacturedProduct() {
        if (asManufacturedProduct == null) {
            asManufacturedProduct = new ArrayList<POCPHD010500UVManufacturedProduct3>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVNamedEntity }
     * 
     * 
     */
    public List<POCPHD010500UVNamedEntity> getAsNamedEntity() {
        if (asNamedEntity == null) {
            asNamedEntity = new ArrayList<POCPHD010500UVNamedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVSpecializedKind }
     * 
     * 
     */
    public List<POCPHD010500UVSpecializedKind> getAsSpecializedKind() {
        if (asSpecializedKind == null) {
            asSpecializedKind = new ArrayList<POCPHD010500UVSpecializedKind>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link POCPHD010500UVEntityWithGeneric }{@code >}
     *     
     */
    public JAXBElement<POCPHD010500UVEntityWithGeneric> getAsEntityWithGeneric() {
     ...
     *     
     */
    public void setAsEntityWithGeneric(JAXBElement<POCPHD010500UVEntityWithGeneric> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVEquivalentEntity }
     * 
     * 
     */
    public List<POCPHD010500UVEquivalentEntity> getAsEquivalentEntity() {
        if (asEquivalentEntity == null) {
            asEquivalentEntity = new ArrayList<POCPHD010500UVEquivalentEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVIngredient }
     * 
     * 
     */
    public List<POCPHD010500UVIngredient> getIngredient() {
        if (ingredient == null) {
            ingredient = new ArrayList<POCPHD010500UVIngredient>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVContent }
     * 
     * 
     */
    public List<POCPHD010500UVContent> getAsContent() {
        if (asContent == null) {
            asContent = new ArrayList<POCPHD010500UVContent>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVPartOfAssembly }
     * 
     * 
     */
    public List<POCPHD010500UVPartOfAssembly> getAsPartOfAssembly() {
        if (asPartOfAssembly == null) {
            asPartOfAssembly = new ArrayList<POCPHD010500UVPartOfAssembly>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010500UVPart }
     * 
     * 
     */
    public List<POCPHD010500UVPart> getPart() {
        if (part == null) {
            part = new ArrayList<POCPHD010500UVPart>();
        }
        return this.part;
    }
