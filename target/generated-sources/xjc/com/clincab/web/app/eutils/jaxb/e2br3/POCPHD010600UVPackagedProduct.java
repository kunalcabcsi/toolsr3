...
/**
 * <p>Java class for POCP_HD010600UV.PackagedProduct complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_HD010600UV.PackagedProduct"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asDistributedProduct" type="{urn:hl7-org:v3}POCP_HD010600UV.DistributedProduct" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asManufacturedProduct" type="{urn:hl7-org:v3}POCP_HD010600UV.ManufacturedProduct2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asContent" type="{urn:hl7-org:v3}POCP_HD010600UV.Content1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_HD010600UV.PackagedProduct", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCPHD010600UVPackagedProduct {
    ...
    @XmlElement(nillable = true)
    protected List<POCPHD010600UVDistributedProduct> asDistributedProduct;
    @XmlElement(nillable = true)
    protected List<POCPHD010600UVManufacturedProduct2> asManufacturedProduct;
    @XmlElement(nillable = true)
    protected List<POCPHD010600UVContent1> asContent;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010600UVDistributedProduct }
     * 
     * 
     */
    public List<POCPHD010600UVDistributedProduct> getAsDistributedProduct() {
        if (asDistributedProduct == null) {
            asDistributedProduct = new ArrayList<POCPHD010600UVDistributedProduct>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010600UVManufacturedProduct2 }
     * 
     * 
     */
    public List<POCPHD010600UVManufacturedProduct2> getAsManufacturedProduct() {
        if (asManufacturedProduct == null) {
            asManufacturedProduct = new ArrayList<POCPHD010600UVManufacturedProduct2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010600UVContent1 }
     * 
     * 
     */
    public List<POCPHD010600UVContent1> getAsContent() {
        if (asContent == null) {
            asContent = new ArrayList<POCPHD010600UVContent1>();
        }
