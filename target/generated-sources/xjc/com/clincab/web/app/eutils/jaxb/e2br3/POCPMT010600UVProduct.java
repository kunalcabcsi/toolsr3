...
/**
 * <p>Java class for POCP_MT010600UV.Product complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_MT010600UV.Product"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asManufacturedProduct" type="{urn:hl7-org:v3}POCP_MT010600UV.ManufacturedProduct3" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asNamedEntity" type="{urn:hl7-org:v3}POCP_MT010600UV.NamedEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="instanceOfKind" type="{urn:hl7-org:v3}POCP_MT020100UV.InstanceOfKind1" minOccurs="0"/&gt;
 *         &lt;element name="asSpecializedKind" type="{urn:hl7-org:v3}POCP_MT010600UV.SpecializedKind" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asEntityWithGeneric" type="{urn:hl7-org:v3}POCP_MT010600UV.EntityWithGeneric" minOccurs="0"/&gt;
 *         &lt;element name="asEquivalentEntity" type="{urn:hl7-org:v3}POCP_MT010600UV.EquivalentEntity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ingredient" type="{urn:hl7-org:v3}POCP_MT010600UV.Ingredient" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asContent" type="{urn:hl7-org:v3}POCP_MT010600UV.Content" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asPartOfAssembly" type="{urn:hl7-org:v3}POCP_MT010600UV.PartOfAssembly" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="part" type="{urn:hl7-org:v3}POCP_MT010600UV.Part" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_MT010600UV.Product", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCPMT010600UVProduct {
    ...
    @XmlElement(nillable = true)
    protected List<POCPMT010600UVManufacturedProduct3> asManufacturedProduct;
    @XmlElement(nillable = true)
    protected List<POCPMT010600UVNamedEntity> asNamedEntity;
    ...
    @XmlElement(nillable = true)
    protected List<POCPMT010600UVSpecializedKind> asSpecializedKind;
    @XmlElementRef(name = "asEntityWithGeneric", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<POCPMT010600UVEntityWithGeneric> asEntityWithGeneric;
    @XmlElement(nillable = true)
    protected List<POCPMT010600UVEquivalentEntity> asEquivalentEntity;
    @XmlElement(nillable = true)
    protected List<POCPMT010600UVIngredient> ingredient;
    @XmlElement(nillable = true)
    protected List<POCPMT010600UVContent> asContent;
    @XmlElement(nillable = true)
    protected List<POCPMT010600UVPartOfAssembly> asPartOfAssembly;
    @XmlElement(nillable = true)
    protected List<POCPMT010600UVPart> part;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010600UVManufacturedProduct3 }
     * 
     * 
     */
    public List<POCPMT010600UVManufacturedProduct3> getAsManufacturedProduct() {
        if (asManufacturedProduct == null) {
            asManufacturedProduct = new ArrayList<POCPMT010600UVManufacturedProduct3>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010600UVNamedEntity }
     * 
     * 
     */
    public List<POCPMT010600UVNamedEntity> getAsNamedEntity() {
        if (asNamedEntity == null) {
            asNamedEntity = new ArrayList<POCPMT010600UVNamedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010600UVSpecializedKind }
     * 
     * 
     */
    public List<POCPMT010600UVSpecializedKind> getAsSpecializedKind() {
        if (asSpecializedKind == null) {
            asSpecializedKind = new ArrayList<POCPMT010600UVSpecializedKind>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link POCPMT010600UVEntityWithGeneric }{@code >}
     *     
     */
    public JAXBElement<POCPMT010600UVEntityWithGeneric> getAsEntityWithGeneric() {
     ...
     *     
     */
    public void setAsEntityWithGeneric(JAXBElement<POCPMT010600UVEntityWithGeneric> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010600UVEquivalentEntity }
     * 
     * 
     */
    public List<POCPMT010600UVEquivalentEntity> getAsEquivalentEntity() {
        if (asEquivalentEntity == null) {
            asEquivalentEntity = new ArrayList<POCPMT010600UVEquivalentEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010600UVIngredient }
     * 
     * 
     */
    public List<POCPMT010600UVIngredient> getIngredient() {
        if (ingredient == null) {
            ingredient = new ArrayList<POCPMT010600UVIngredient>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010600UVContent }
     * 
     * 
     */
    public List<POCPMT010600UVContent> getAsContent() {
        if (asContent == null) {
            asContent = new ArrayList<POCPMT010600UVContent>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010600UVPartOfAssembly }
     * 
     * 
     */
    public List<POCPMT010600UVPartOfAssembly> getAsPartOfAssembly() {
        if (asPartOfAssembly == null) {
            asPartOfAssembly = new ArrayList<POCPMT010600UVPartOfAssembly>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPMT010600UVPart }
     * 
     * 
     */
    public List<POCPMT010600UVPart> getPart() {
        if (part == null) {
            part = new ArrayList<POCPMT010600UVPart>();
        }
        return this.part;
    }
