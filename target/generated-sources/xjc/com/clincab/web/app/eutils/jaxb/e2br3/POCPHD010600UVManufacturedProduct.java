...
/**
 * <p>Java class for POCP_HD010600UV.ManufacturedProduct complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_HD010600UV.ManufacturedProduct"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;group ref="{urn:hl7-org:v3}InfrastructureRootElements"/&gt;
 *         &lt;element name="id" type="{urn:hl7-org:v3}II" minOccurs="0"/&gt;
 *         &lt;element name="manufacturedProduct" type="{urn:hl7-org:v3}POCP_HD010600UV.Product"/&gt;
 ...
 *         &lt;element name="deviceOf" type="{urn:hl7-org:v3}POCP_HD010600UV.Device" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="consumedIn" type="{urn:hl7-org:v3}POCP_HD010600UV.Consumable1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="productOf" type="{urn:hl7-org:v3}POCP_HD010600UV.Product3" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="indirectTargetOf" type="{urn:hl7-org:v3}POCP_HD010600UV.IndirectTarget" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_HD010600UV.ManufacturedProduct", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCPHD010600UVManufacturedProduct {
    ...
    protected POCPHD010600UVProduct manufacturedProduct;
    ...
    @XmlElement(nillable = true)
    protected List<POCPHD010600UVDevice> deviceOf;
    @XmlElement(nillable = true)
    protected List<POCPHD010600UVConsumable1> consumedIn;
    @XmlElement(nillable = true)
    protected List<POCPHD010600UVProduct3> productOf;
    @XmlElement(nillable = true)
    protected List<POCPHD010600UVIndirectTarget> indirectTargetOf;
     ...
     * @return
     *     possible object is
     *     {@link POCPHD010600UVProduct }
     *     
     */
    public POCPHD010600UVProduct getManufacturedProduct() {
     ...
     *     
     */
    public void setManufacturedProduct(POCPHD010600UVProduct value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010600UVDevice }
     * 
     * 
     */
    public List<POCPHD010600UVDevice> getDeviceOf() {
        if (deviceOf == null) {
            deviceOf = new ArrayList<POCPHD010600UVDevice>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010600UVConsumable1 }
     * 
     * 
     */
    public List<POCPHD010600UVConsumable1> getConsumedIn() {
        if (consumedIn == null) {
            consumedIn = new ArrayList<POCPHD010600UVConsumable1>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010600UVProduct3 }
     * 
     * 
     */
    public List<POCPHD010600UVProduct3> getProductOf() {
        if (productOf == null) {
            productOf = new ArrayList<POCPHD010600UVProduct3>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010600UVIndirectTarget }
     * 
     * 
     */
    public List<POCPHD010600UVIndirectTarget> getIndirectTargetOf() {
        if (indirectTargetOf == null) {
            indirectTargetOf = new ArrayList<POCPHD010600UVIndirectTarget>();
        }
