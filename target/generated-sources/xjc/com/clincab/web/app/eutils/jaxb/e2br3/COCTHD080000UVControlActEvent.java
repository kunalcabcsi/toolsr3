...
/**
 * <p>Java class for COCT_HD080000UV.ControlActEvent complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_HD080000UV.ControlActEvent"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="overseer" type="{urn:hl7-org:v3}COCT_HD080000UV.Overseer" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="authorOrPerformer" type="{urn:hl7-org:v3}COCT_HD080000UV.AuthorOrPerformer" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="dataEnterer" type="{urn:hl7-org:v3}COCT_HD080000UV.DataEnterer" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="informationRecipient" type="{urn:hl7-org:v3}COCT_HD080000UV.InformationRecipient" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "COCT_HD080000UV.ControlActEvent", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class COCTHD080000UVControlActEvent {
    ...
    protected List<COCTHD080000UVOverseer> overseer;
    @XmlElement(nillable = true)
    protected List<COCTHD080000UVAuthorOrPerformer> authorOrPerformer;
    @XmlElement(nillable = true)
    protected List<COCTHD080000UVDataEnterer> dataEnterer;
    @XmlElement(nillable = true)
    protected List<COCTHD080000UVInformationRecipient> informationRecipient;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD080000UVOverseer }
     * 
     * 
     */
    public List<COCTHD080000UVOverseer> getOverseer() {
        if (overseer == null) {
            overseer = new ArrayList<COCTHD080000UVOverseer>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD080000UVAuthorOrPerformer }
     * 
     * 
     */
    public List<COCTHD080000UVAuthorOrPerformer> getAuthorOrPerformer() {
        if (authorOrPerformer == null) {
            authorOrPerformer = new ArrayList<COCTHD080000UVAuthorOrPerformer>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD080000UVDataEnterer }
     * 
     * 
     */
    public List<COCTHD080000UVDataEnterer> getDataEnterer() {
        if (dataEnterer == null) {
            dataEnterer = new ArrayList<COCTHD080000UVDataEnterer>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTHD080000UVInformationRecipient }
     * 
     * 
     */
    public List<COCTHD080000UVInformationRecipient> getInformationRecipient() {
        if (informationRecipient == null) {
            informationRecipient = new ArrayList<COCTHD080000UVInformationRecipient>();
        }
