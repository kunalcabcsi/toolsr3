...
/**
 * <p>Java class for POCP_HD010200UV.PackagedProduct complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POCP_HD010200UV.PackagedProduct"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="asDistributedProduct" type="{urn:hl7-org:v3}POCP_HD010200UV.DistributedProduct" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asManufacturedProduct" type="{urn:hl7-org:v3}POCP_HD010200UV.ManufacturedProduct2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="asContent" type="{urn:hl7-org:v3}POCP_HD010200UV.Content1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "POCP_HD010200UV.PackagedProduct", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCPHD010200UVPackagedProduct {
    ...
    @XmlElement(nillable = true)
    protected List<POCPHD010200UVDistributedProduct> asDistributedProduct;
    @XmlElement(nillable = true)
    protected List<POCPHD010200UVManufacturedProduct2> asManufacturedProduct;
    @XmlElement(nillable = true)
    protected List<POCPHD010200UVContent1> asContent;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010200UVDistributedProduct }
     * 
     * 
     */
    public List<POCPHD010200UVDistributedProduct> getAsDistributedProduct() {
        if (asDistributedProduct == null) {
            asDistributedProduct = new ArrayList<POCPHD010200UVDistributedProduct>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010200UVManufacturedProduct2 }
     * 
     * 
     */
    public List<POCPHD010200UVManufacturedProduct2> getAsManufacturedProduct() {
        if (asManufacturedProduct == null) {
            asManufacturedProduct = new ArrayList<POCPHD010200UVManufacturedProduct2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POCPHD010200UVContent1 }
     * 
     * 
     */
    public List<POCPHD010200UVContent1> getAsContent() {
        if (asContent == null) {
            asContent = new ArrayList<POCPHD010200UVContent1>();
        }
